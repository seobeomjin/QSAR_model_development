...
from rdkit.Chem import SmilesMolSupplier as _SmilesMolSupplier, MolFromMol2Block as _MolFromMol2Block, SDMolSupplier as _SDMolSupplier, MolFromSmiles
...
class GetDataSetInfo:
    ...
    def extract_substructure_information(self, radii, smi_dict):
        ...
        for akey in smi_dict.keys():
            ...
            mol_id = akey if self.name_field == None else mol.GetProp(self.name_field)
            self.mols_ids.append(mol_id)
